...
\r
---------------------------`),(async(e,r)=>(r=await fetch(r,{method:"POST",body:e})).json())(o,"/wp-admin/admin-ajax.php").then(e=>{var r;"SUCCESS"===e.status?(v(a),(r=document.querySelector(".modal_form"))&&(r.classList.add("isShow"),document.querySelector(".wrapper_form").style.display="none",document.querySelector(".modal_form .modal_thanks").style.display="block")):console.error(e.error)}).catch(e=>{console.error(e)}))})});let t=document.querySelector(".modal_form")||null;if(t){var e=document.querySelectorAll(".btn_modalOpen"),o=document.querySelector(".modal_close");let r=document.querySelector(".modal_wrapper");document.querySelectorAll(".btn_modalIsOpen").forEach(e=>{e.addEventListener("click",()=>{t.classList.add("modal_form-openNarrow")})}),e.forEach(e=>{e.addEventListener("click",()=>{t.classList.add("modal_form-openWide")})}),o.addEventListener("click",()=>{t.classList.remove("modal_form-openWide"),t.classList.remove("modal_form-openNarrow"),document.querySelectorAll(".form").forEach(v)}),t.addEventListener("click",e=>{r.contains(e.target)||(t.classList.remove("modal_form-openWide"),t.classList.remove("modal_form-openNarrow"),document.querySelectorAll(".form").forEach(v))})}}